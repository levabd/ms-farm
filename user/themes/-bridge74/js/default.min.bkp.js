function getScrollAmountForStickyHeader() { return "undefined" != typeof page_scroll_amount_for_sticky ? amount = page_scroll_amount_for_sticky : $j(".carousel.full_screen").length ? amount = $j(".carousel").height() : amount = scroll_amount_for_sticky, amount }
    ...
    if ($j("header.page_header").hasClass("scroll_top") && $j("header.page_header").hasClass("has_top") && ($j("header.page_header").hasClass("fixed") || $j("header.page_header").hasClass("fixed_hiding")) && (a >= 0 && 34 >= a ? ($j("header.page_header").css("top", -a), $j("header.page_header").css("margin-top", 0), $j(".header_top").show()) : a > 34 && ($j("header.page_header").css("top", "-34px"), $j("header.page_header").css("margin-top", 34), $j(".header_top").hide())), sticky_amount = getScrollAmountForStickyHeader(), $j("header").hasClass("regular") && (header_height - logo_height >= 10 ? $j(".q_logo a").height(logo_height) : $j(".q_logo a").height(header_height - 10), $j(".q_logo a img").css("height", "100%")), $j("header.page_header").hasClass("fixed") && ($top_header_height = $j("header.page_header").hasClass("scroll_top") ? 34 : 0, header_height - a + $top_header_height >= min_header_height_scroll && a >= $top_header_height ? ($j("header.page_header").removeClass("scrolled"), $j("header:not(.centered_logo.centered_logo_animate) nav.main_menu > ul > li > a").css("line-height", header_height - a + $top_header_height + "px"), $j("header:not(.centered_logo.centered_logo_animate) .side_menu_button").css("height", header_height - a + $top_header_height + "px"), $j("header:not(.centered_logo.centered_logo_animate) .shopping_cart_inner").css("height", header_height - a + $top_header_height + "px"), $j("header:not(.centered_logo.centered_logo_animate) .logo_wrapper").css("height", header_height - a + $top_header_height + "px"), header_height - logo_height > 0 ? $j("header:not(.centered_logo.centered_logo_animate) .q_logo a").css("height", logo_height + "px") : $j("header:not(.centered_logo.centered_logo_animate) .q_logo a").css("height", header_height - a + $top_header_height - 10 + "px")) : $top_header_height > a ? ($j("header.page_header").removeClass("scrolled"), $j("header:not(.centered_logo.centered_logo_animate) nav.main_menu > ul > li > a").css("line-height", header_height + "px"), $j("header:not(.centered_logo.centered_logo_animate) .side_menu_button").css("height", header_height + "px"), $j("header:not(.centered_logo.centered_logo_animate) .shopping_cart_inner").css("height", header_height + "px"), $j("header:not(.centered_logo.centered_logo_animate) .logo_wrapper").css("height", header_height + "px"), header_height - logo_height > 0 ? $j("header:not(.centered_logo.centered_logo_animate) .q_logo a").css("height", logo_height + "px") : $j("header:not(.centered_logo.centered_logo_animate) .q_logo a").css("height", header_height - 10 + "px")) : header_height - a + $top_header_height < min_header_height_scroll && ($j("header.page_header").addClass("scrolled"), $j("header:not(.centered_logo.centered_logo_animate) nav.main_menu > ul > li > a").css("line-height", min_header_height_scroll + "px"), $j("header:not(.centered_logo.centered_logo_animate) .side_menu_button").css("height", min_header_height_scroll + "px"), $j("header:not(.centered_logo.centered_logo_animate) .shopping_cart_inner").css("height", min_header_height_scroll + "px"), $j("header:not(.centered_logo.centered_logo_animate) .logo_wrapper").css("height", min_header_height_scroll + "px"), min_header_height_scroll - logo_height > 0 ? $j("header:not(.centered_logo.centered_logo_animate) .q_logo a").css("height", logo_height + "px") : $j("header:not(.centered_logo.centered_logo_animate) .q_logo a").css("height", min_header_height_scroll - 10 + "px")), $j("header.page_header").hasClass("centered_logo") && $j("header.page_header").hasClass("centered_logo_animate") ? header_height - a + $top_header_height < logo_height && header_height - a + $top_header_height >= min_header_height_scroll && logo_height > min_header_height_scroll - 10 && a >= $top_header_height ? $j(".q_logo a").height(header_height - a + $top_header_height - 10) : header_height - a + $top_header_height < logo_height && header_height - a + $top_header_height >= min_header_height_scroll && logo_height > min_header_height_scroll - 10 && $top_header_height > a ? $j(".q_logo a").height(header_height - 10) : header_height - a + $top_header_height < logo_height && header_height - a + $top_header_height < min_header_height_scroll && logo_height > min_header_height_scroll - 10 ? $j(".q_logo a").height(min_header_height_scroll - 10) : header_height - a + $top_header_height < logo_height && header_height - a + $top_header_height < min_header_height_scroll && logo_height < min_header_height_scroll - 10 ? $j(".q_logo a").height(logo_height) : a + $top_header_height === 0 && logo_height > header_height - 10 ? $j(".q_logo a").height(logo_height) : $j(".q_logo a").height(logo_height) : $j("header.page_header").hasClass("centered_logo") ? ($j(".q_logo a").height(logo_height), $j(".q_logo img").height("auto")) : $j(".q_logo img").height("100%"), setLeftPostionedMenuPadding()), $j("header.page_header").hasClass("fixed_hiding") && (a < scroll_amount_for_fixed_hiding ? $j("header.page_header").removeClass("scrolled") : $j("header.page_header").addClass("scrolled"), $j(".q_logo a").height(logo_height / 2), $j(".q_logo img").height("100%")), $j("header.page_header").hasClass("stick") || $j("header.page_header").hasClass("stick_with_left_right_menu")) {
        if (a > sticky_amount) {
            if (!$j("header.page_header").hasClass("sticky")) {
                ...
                $j("header.page_header").hasClass("menu_bottom") && (b = header_height + 60), $j("header.page_header").addClass("sticky"), $j(".content").css("padding-top", b), window.clearTimeout(sticky_animate), sticky_animate = window.setTimeout(function() { $j("header.page_header").addClass("sticky_animate") }, 100), min_header_height_sticky - logo_height >= 10 ? $j(".q_logo a").height(logo_height) : $j(".q_logo a").height(min_header_height_sticky - 10), $j("header.page_header").hasClass("menu_bottom") && initDropDownMenu()
            }
...
function setLeftPostionedMenuPadding() {
    ...
    if (a.length && a.hasClass("left")) {
        var b = $j(".q_logo a img").filter(function() { return "1" == $j(this).css("opacity") });
        a.css("left", b.width())
    }
}
...
function initQodeSlider() {
    ...
    if (default_header_style = "", $j("header.page_header").hasClass("light") && (default_header_style = "light"), $j("header.page_header").hasClass("dark") && (default_header_style = "dark"), $j(".carousel").length) {
        var b = { zoom_center: "1.2, 0, 0, 1.2, 0, 0", zoom_top_left: "1.2, 0, 0, 1.2, -150, -150", zoom_top_right: "1.2, 0, 0, 1.2, 150, -150", zoom_bottom_left: "1.2, 0, 0, 1.2, -150, 150", zoom_bottom_right: "1.2, 0, 0, 1.2, 150, 150" };
        ! function(a) {
            var b = /\([0-9epx\.\, \t\-]+/gi,
                c = function(a) { return a.match(b)[0].substr(1).split(",").map(function(a) { return parseFloat(a) }) },
                d = ["transform", "-webkit-transform"],
                e = function(a) { var b = null; return d.some(function(c) { return b = a.css(c), null !== b && "" !== b }), b = b && "none" !== b ? b : "matrix(1,0,0,1,0,0)", c(b) },
                f = function(a, b) { for (var c = "matrix(" + b.join(",") + ")", e = d.length - 1; e >= 0; --e) a.css(d[e], c + " rotate(0.01deg)") },
                g = function(a, b, c) { return a + (b - a) * (c / 100) };
            a.fn.transformAnimate = function(b) {
                ...
                return d.step = function(c, d) {
                    var e = a(this),
                        j = h.map(function(a, b) { return g(a, i[b], c) });
            ...
            function d(a) { p.css({ height: a + "px" }), p.find(".qode_slider_preloader").css({ height: a + "px" }), p.find(".qode_slider_preloader .ajax_loader").css({ display: "block" }), p.find(".item").css({ height: a + "px" }) }
            ...
            if ($j("body:not(.boxed):not(.vertical_menu_transparency):not(.vertical_menu_hidden):not(.page-template-landing_page-php)").hasClass("vertical_menu_enabled") && $j(window).width() > 1e3) {
                ...
                p.find(".carousel-inner").width($window_width - 260 - A), $j(window).resize(function() { $j(window).width() > 1e3 ? (A = $j("body").hasClass("paspartu_enabled") ? 2 * Math.round($window_width * paspartu_width) : 0, p.find(".carousel-inner").width($window_width - 260 - A)) : p.find(".carousel-inner").css("width", "100%") })
            }
            if ($j("body:not(.boxed):not(.vertical_menu_transparency):not(.page-template-landing_page-php)").hasClass("vertical_menu_hidden") && $window_width > 1e3) {
                var A = $j("body").hasClass("paspartu_enabled") ? 2 * Math.round($window_width * paspartu_width) : 0;
                p.find(".carousel-inner").width($window_width - 40 - A), $j(window).resize(function() { $j(window).width() > 1e3 ? (A = $j("body").hasClass("paspartu_enabled") ? 2 * Math.round($window_width * paspartu_width) : 0, p.find(".carousel-inner").width($window_width - 40 - A)) : p.find(".carousel-inner").css("width", "100%") })
            }
            $j(window).scroll(function() { $scroll > p.height() + $j("header.page_header").height() && $j(window).width() > 1e3 ? p.find(".carousel-inner, .carousel-indicators, button").hide() : p.find(".carousel-inner, .carousel-indicators, button").show() });
            ...
            if ($j("html").hasClass("touch")) {
                if (p.find(".item:first-child .mobile-video-image").length > 0) {
                    if (src = a.exec(p.find(".item:first-child .mobile-video-image").attr("style"))) {
                        var D = new Image;
                        D.src = src[1], $j(D).load(function() { $j(".qode_slider_preloader").fadeOut(500), i(), checkSVG(p) })
                    }
                } else if (src = a.exec(p.find(".item:first-child .image").attr("style"))) {
                    var D = new Image;
                    D.src = src[1], $j(D).load(function() { $j(".qode_slider_preloader").fadeOut(500), i(), checkSVG(p) })
                }
            } else if (p.find(".item:first-child video").length > 0) p.find(".item:first-child video").get(0).addEventListener("loadeddata", function() { $j(".qode_slider_preloader").fadeOut(500), i(), checkSVG(p) });
            else if (src = a.exec(p.find(".item:first-child .image").attr("style"))) {
                var D = new Image;
                D.src = src[1], $j(D).load(function() { $j(".qode_slider_preloader").fadeOut(500), i(), checkSVG(p) })
            }
            p.on("slide.bs.carousel", function() { p.addClass("in_progress"), p.find(".active .slider_content_outer").fadeTo(800, 0) }), p.on("slid.bs.carousel", function() {
                if (p.removeClass("in_progress"), p.find(".active .slider_content_outer").fadeTo(0, 1), checkSVG(p), $j("div.item.animate_image .image").stop().css({ transform: "", "-webkit-transform": "" }), $j("div.item.active").hasClass("animate_image") && $window_width > 1e3 && $j("div.item.animate_image.active .image").transformAnimate({ transform: "matrix(" + b[$j("div.item.animate_image.active").data("animate_image")] + ")", duration: 3e4 }), p.hasClass("slider_thumbs")) {
            ...
            }), p.swipe({ swipeLeft: function(a, b, c, d, e) { p.carousel("next") }, swipeRight: function(a, b, c, d, e) { p.carousel("prev") }, threshold: 20 })
...
function calculateHeights() { $j(".portfolio_slides").length && $j(".portfolio_slides").each(function() { $j(this).parents(".caroufredsel_wrapper").css({ height: $j(this).find("li.item").outerHeight() - 3 + "px" }) }), $j(".qode_carousels .slides").length && $j(".qode_carousels .slides").each(function() { $j(this).parents(".caroufredsel_wrapper").css({ height: $j(this).find("li.item").outerHeight() + "px" }) }), $j(".blog_slides").length && $j(".blog_slides").each(function() { $j(this).parents(".caroufredsel_wrapper").css({ height: $j(this).find("li.item").outerHeight() - 3 + "px" }) }) }
...
function initQodeCarousel() {
    ...
    $j(".qode_carousels").length && ($j(".qode_carousels").each(function() {
        ...
        var c = 1 == a.parents(".grid_section").length ? 170 : 315,
            d = 6;
        4 === b ? (c = 1 == a.parents(".grid_section").length ? 255 : 472, d = 4) : 5 === b && (c = 1 == a.parents(".grid_section").length ? 204 : 378, d = 5), a.find(".slides").carouFredSel({ circular: !0, responsive: !0, scroll: { items: 1, duration: 1e3, pauseOnHover: !1 }, items: { width: c, visible: { min: 1, max: d } }, auto: !0, mousewheel: !1, swipe: { onMouse: !0, onTouch: !0 } }).animate({ opacity: 1 }, 1e3)
    }), calculateHeights())
}
...
function initPortfolioSlider() {
    ...
    $j(".portfolio_slider").length && ($j(".portfolio_slider").each(function() {
        ...
        $j(this).find(".portfolio_slides").carouFredSel({ circular: !0, responsive: !0, scroll: 1, prev: { button: function() { return $j(this).parent().siblings(".caroufredsel-direction-nav").find("#caroufredsel-prev") } }, next: { button: function() { return $j(this).parent().siblings(".caroufredsel-direction-nav").find("#caroufredsel-next") } }, items: { width: d, visible: { min: 1, max: c } }, auto: !1, mousewheel: !1, swipe: { onMouse: !0, onTouch: !0 } }).animate({ opacity: 1 }, 1e3)
    }), calculateHeights(), $j(".portfolio_slider .flex-direction-nav a").click(function(a) { a.preventDefault(), a.stopImmediatePropagation(), a.stopPropagation() }))
}
...
function initDropDownMenu() {
    ...
    a.each(function(b) {
        if ($j(a[b]).find(".second").length > 0) {
            ...
            if (menu_dropdown_height_set || ($j(a[b]).data("original_height", $j(a[b]).find(".second").height() + "px"), $j(a[b]).find(".second").height(0)), navigator.userAgent.match(/(iPod|iPhone|iPad)/)) $j(a[b]).on("touchstart mouseenter", function() { $j(a[b]).find(".second").css({ height: $j(a[b]).data("original_height"), overflow: "visible", visibility: "visible", opacity: "1" }) }).on("mouseleave", function() { $j(a[b]).find(".second").css({ height: "0px", overflow: "hidden", visivility: "hidden", opacity: "0" }) });
            else {
                var i = { interval: 0, over: function() { setTimeout(function() { $j(a[b]).find(".second").addClass("drop_down_start"), $j(a[b]).find(".second").stop().css({ height: $j(a[b]).data("original_height") }) }, 150) }, timeout: 150, out: function() { $j(a[b]).find(".second").stop().css({ height: "0px" }), $j(a[b]).find(".second").removeClass("drop_down_start") } };
                $j(a[b]).hoverIntent(i)
            }
        }
    }), $j(".drop_down ul li.wide ul li a, .drop_down ul li.narrow ul li a").on("click", function() {
        var a = $j(this);
        a.next("ul").length || "http://#" === a.attr("href") || "#" === a.attr("href") || a.hasClass("no_link") || setTimeout(function() { a.mouseleave() }, 500)
    ...
    if ($j(".no-touch .vertical_menu_toggle").length) {
        ...
        a.each(function(b) {
            if ($j(a[b]).hasClass("has_sub")) {
                ...
                $j(a[b]).hoverIntent({ over: function() { $j(a[b]).addClass("open"), $j(a[b]).find(".second").slideDown(40 * c, "easeInOutSine", function() { $j(".vertical_menu_area.with_scroll").getNiceScroll().resize() }) }, out: function() { $j(a[b]).removeClass("open"), $j(a[b]).find(".second").slideUp(40 * c, "easeInOutSine") }, timeout: 1e3 })
            }
        }), b.each(function(a) {
            if ($j(b[a]).hasClass("menu-item-has-children")) {
                var c = $j(b[a]).find("ul > li").length;
                $j(b[a]).hoverIntent({ over: function() { $j(b[a]).addClass("open"), $j(b[a]).find("ul").slideDown(40 * c, "easeInOutSine", function() { $j(".vertical_menu_area.with_scroll").getNiceScroll().resize() }) }, out: function() { $j(b[a]).removeClass("open"), $j(b[a]).find("ul").slideUp(40 * c, "easeInOutSine") }, timeout: 1e3 })
            }
        })
    } else if ($j(".vertical_menu_on_click").length) {
        var a = $j(".vertical_menu_on_click > ul > li > a"),
            b = $j(".vertical_menu_on_click ul li ul li a");
        a.each(function(b) { $j(a[b]).parent().hasClass("has_sub") && $j(a[b]).on("tap click", function(a) { return a.preventDefault(), $j(this).parent().hasClass("open") ? ($j(this).parent().removeClass("open"), $j(this).parent().find(".second").slideUp("fast", function() { $j(".vertical_menu_area.with_scroll").getNiceScroll().resize() })) : ($j(".vertical_menu_on_click > ul > li").removeClass("open"), $j(".vertical_menu_on_click > ul > li").find(".second").slideUp("fast"), $j(this).parent().addClass("open"), $j(this).parent().find(".second").slideDown("slow", function() { $j(".vertical_menu_area.with_scroll").getNiceScroll().resize() })), !1 }) }), b.each(function(a) { $j(b[a]).parent().hasClass("menu-item-has-children") && $j(b[a]).on("tap click", function(a) { return a.preventDefault(), $j(this).parent().hasClass("open") ? ($j(this).parent().removeClass("open"), $j(this).parent().find("ul").slideUp("fast", function() { $j(".vertical_menu_area.with_scroll").getNiceScroll().resize() })) : ($j(".vertical_menu_on_click ul li ul li").removeClass("open"), $j(".vertical_menu_on_click ul li ul li").find("ul").slideUp("fast"), $j(this).parent().addClass("open"), $j(this).parent().find("ul").slideDown("slow", function() { $j(".vertical_menu_area.with_scroll").getNiceScroll().resize() })), !1 }) })
    } else if ($j(".no-touch .vertical_menu_float").length) {
        var a = $j(".no-touch .vertical_menu_float > ul > li"),
            b = $j(".no-touch .vertical_menu_float ul li ul li");
        a.each(function(b) { $j(a[b]).hasClass("has_sub") && $j(a[b]).hoverIntent({ over: function() { $j(a[b]).addClass("open"), $j(a[b]).find(".second").addClass("vertical_menu_start") }, out: function() { $j(a[b]).removeClass("open"), $j(a[b]).find(".second").removeClass("vertical_menu_start") }, timeout: 300 }) }), b.each(function(a) {
            if ($j(b[a]).hasClass("menu-item-has-children")) {
                $j(b[a]).find("ul > li").length;
                $j(b[a]).hoverIntent({ over: function() { $j(b[a]).addClass("open"), $j(b[a]).find("ul").addClass("vertical_submenu_start") }, out: function() { $j(b[a]).removeClass("open"), $j(b[a]).find("ul").removeClass("vertical_submenu_start") }, timeout: 300 })
            }
        })
    }
}
...
function showHideVerticalMenu() {
    if ($j(".vertical_menu_hidden").length) {
        var a = $j("aside.vertical_menu_area"),
            ...
            c = !0;
        $j(".vertical_menu_hidden_button").on("click", function(d) { d.preventDefault(), c ? (c = !1, current_scroll = $j(window).scrollTop(), a.addClass("active"), b.addClass("active")) : (c = !0, a.removeClass("active"), b.removeClass("active")) }), $j(window).scroll(function() { Math.abs($scroll - current_scroll) > 400 && (c = !0, a.removeClass("active"), b.removeClass("active")) }),
            function() {
                var a, b;
                a = function() {
                    function a() { this.objects = [] }
                    return a.name = "Outclick", a.prototype.check = function(a, b) { return !a.is(b.target) && 0 === a.has(b.target).length }, a.prototype.trigger = function(a) { var b, c = this; return b = !1, $j.each(this.objects, function(d, e) { return c.check(e.container, a) && (e.related.length < 1 ? b = !0 : $j.each(e.related, function(d, e) { return c.check(e, a) ? b = !0 : (b = !1, !1) }), b) ? e.callback.call(e.container) : void 0 }) }, a
                }(), b = new a, $j.fn.outclick = function(a) { var c = this; return null == a && (a = {}), a.related || (a.related = []), a.callback || (a.callback = function() { return c.hide() }), b.objects.push({ container: this, related: a.related, callback: a.callback }) }, $j(document).mouseup(function(a) { return b.trigger(a) })
            }.call(this), $j(a).outclick({ callback: function() { c = !0, a.removeClass("active"), b.removeClass("active") } })
    }
}
...
function initCounter() {
    "use strict";
    $j(".counter.random").length && $j(".counter.random").each(function() { $j(this).hasClass("executed") || ($j(this).addClass("executed"), $j(this).parents(".vertical_split_slider").length ? ($j(this).parent().css("opacity", "1"), $j(this).absoluteCounter({ speed: 2e3, fadeInDelay: 1e3 })) : $j(this).appear(function() { $j(this).parent().css("opacity", "1"), $j(this).absoluteCounter({ speed: 2e3, fadeInDelay: 1e3 }) }, { accX: 0, accY: -200 })) })
}
...
function initToCounterHorizontalProgressBar(a) {
    ...
    a.find(".progress_number span").length && a.find(".progress_number span").each(function() { $j(this).parents(".progress_number_wrapper").css("opacity", "1"), $j(this).countTo({ from: 0, to: b, speed: 1500, refreshInterval: 50 }) })
}
    ...
    $j(".animate_list").length > 0 && 0 === $j(".no_animation_on_touch").length && $j(".animate_list").each(function() {
        $j(this).appear(function() {
            $j(this).find("li").each(function(a) {
                var b = $j(this);
                setTimeout(function() { b.animate({ opacity: 1, top: 0 }, 1500) }, 100 * a)
            })
        }, { accX: 0, accY: -200 })
    })
}
...
function initPieChart() {
    ...
    $j(".q_percentage").length && $j(".q_percentage").each(function() {
        ...
        var d = 174;
        $j(this).appear(function() { initToCounterPieChart($j(this)), $j(this).parent().css("opacity", "1"), $j(this).easyPieChart({ barColor: a, trackColor: b, scaleColor: !1, lineCap: "butt", lineWidth: c, animate: 1500, size: d }) }, { accX: 0, accY: -200 })
    })
}
...
function initPieChartWithIcon() {
    ...
    $j(".q_percentage_with_icon").length && $j(".q_percentage_with_icon").each(function() {
        ...
        "" !== $j(this).data("linewidth") && (c = $j(this).data("linewidth"));
        var d = 174;
        $j(this).appear(function() { $j(this).parent().css("opacity", "1"), $j(this).css("opacity", "1"), $j(this).easyPieChart({ barColor: a, trackColor: b, scaleColor: !1, lineCap: "butt", lineWidth: c, animate: 1500, size: d }) }, { accX: 0, accY: -200 })
    })
}
...
function initPortfolio() {
    ...
    $j(".projects_holder_outer:not(.masonry_with_space, .justified_gallery)").length && $j(".projects_holder_outer").each(function() {
        ...
        var c;
        c = window.location.hash && 1 == window.location.hash.indexOf("portfolio_category") ? window.location.hash.replace("#", "") : "all", a.mixitup({
            showOnLoad: c,
            transitionSpeed: 600,
            minHeight: 150,
            onMixLoad: function() {
                $j(".projects_holder").addClass("hideItems"), $j(".projects_holder article").css("visibility", "visible"), a.hasClass("portfolio_one_by_one") && a.find("article").each(function(a) {
                    ...
                    setTimeout(function() { b.addClass("show") }, 100 * a)
                }), a.hasClass("slide_from_left") && a.find("article").each(function(a) {
                    var b = $j(this);
                    setTimeout(function() { b.addClass("show") }, 200 * Math.random())
                }), a.hasClass("slide_from_top") && a.find("article").each(function(a) {
                    var c = $j(this);
                    setTimeout(function() { c.addClass("show") }, 50 * b[a])
...
function initPortfolioZIndex() {
    "use strict";
    $j(".projects_holder_outer.portfolio_no_space").length && $j(".no_space.hover_text article").each(function(a) { $j(this).css("z-index", a + 10) })
}
...
function initPortfolioJustifiedGallery() {
    ...
    a.each(function() {
        ...
        a.find("li.filter").first().addClass("current"), a.find(".filter").on("click", function() {
            var c = $j(this).text(),
                d = a.find(".label span");
            d.each(function() { $j(this).text(c) });
            var e = $j(this).attr("data-filter"),
                f = b.find("article"),
                g = 500;
            return f.css("transition", "all " + g + "ms ease"), f.not(e).css({ transform: "scale(0)" }), setTimeout(function() { f.filter(e).css({ transform: "" }), b.css("transition", "height " + g + "ms ease").justifiedGallery({ selector: ">article" + ("*" != e ? e : "") }) }, 1.1 * g), setTimeout(function() { f.css("transition", ""), b.css("transition", "") }, 2.2 * g), $j(".filter").removeClass("current active"), $j(this).addClass("current active"), !1
        });
        var b = $j(this).find(".projects_holder"),
            c = "undefined" != typeof b.data("row-height") ? b.data("row-height") : 200,
            d = "undefined" != typeof b.data("spacing") ? b.data("spacing") : 0,
            e = "undefined" != typeof b.data("last-row") ? b.data("last-row") : "nojustify",
            f = "undefined" != typeof b.data("justify-threshold") ? b.data("justify-threshold") : .75;
        b.justifiedGallery({ captions: !1, rowHeight: c, margins: d, border: 0, lastRow: e, justifyThreshold: f, selector: "> article" }).on("jg.complete jg.rowflush", function() { $j(this).find("article").addClass("show").each(function() { $j(this).height(Math.round($j(this).height())) }) })
    })
}
...
function initPortfolioMasonryFilter() {
    ...
    if (a.length) {
        ...
        $j(".filter:first").addClass("current"), $j(".filter").click(function() {
            clearTimeout(b), $j(".isotope, .isotope .isotope-item").css("transition-duration", "0.8s"), b = setTimeout(function() { $j(".isotope, .isotope .isotope-item").css("transition-duration", "0s") }, 700);
...
function initPortfolioMasonry() {
    ...
    a.length && a.each(function() {
        ...
        a.hasClass("projects_masonry_holder") && resizeMasonry(c, b), qodeInitMasonry(b), $j(window).resize(function() { setPortfolioMasZIndex(), a.hasClass("projects_masonry_holder") && resizeMasonry(c, b), qodeInitMasonry(b) })
    })
}
...
function qodeInitMasonry(a) {
    a.waitForImages(function() {
        a.animate({
            opacity: 1
        }), a.isotope({ itemSelector: ".portfolio_masonry_item, .masonry_with_space .mix", masonry: { columnWidth: ".qode-portfolio-masonry-gallery-grid-sizer" } }), a.hasClass("portfolio_one_by_one") && a.find("article").each(function(a) {
            var b = $j(this);
            setTimeout(function() { b.addClass("show") }, 100 * a)
        }), a.hasClass("portfolio_fade_from_bottom") && a.find("article").each(function(a) {
            var b = $j(this);
            $j(this).css({ opacity: "0", transform: "translateY(150px)" }), $j(this).appear(function() { setTimeout(function() { b.css({ opacity: "1", transition: "all .8s ease", transform: "translateY(0)" }) }, 100) }, { accX: 0, accY: -150 })
        })
    })
}
...
function setPortfolioMasZIndex() {
    var a = {},
        b = {};
    $j(".projects_masonry_holder article").each(function() { a[$j(this).index()] = getPortfolioXPos($j(this).css("left")) });
    var c = $j.map(a, function(a) { return a });
    c = cleanPortfolioMasXArray(c), c.sort(function(a, b) { return a - b });
    for (var d = 0; d < c.length; d++) b[c[d]] = 10 * d;
    $j.each(a, function(a, c) {
        var d, e = c;
        $j.each(b, function(a, b) { e == a && (d = b) }), $j(".projects_masonry_holder article:eq(" + a + ")").css("z-index", d)
    })
}
...
function getPortfolioXPos(a) { return a.substr(0, a.length - 2) }
...
function initTitleAreaAnimation() {
    if ($j(".title_outer.animate_title_area").length) {
        var a = $j(".title_outer").data("height");
        $j(".title_outer").hasClass("with_image") && (a = $j(".image.responsive").height()), $scroll < $j(".title").height() && $j(".title_outer").animate({ height: a, opacity: 1 }, 500, function() { $j(this).css({ overflow: "visible" }), initPortfolioSingleInfo(), $j("nav.content_menu").length > 0 && (content_menu_position = $j("nav.content_menu").offset().top, contentMenuPosition()) })
    }
}
...
function loadMore() {
    ...
    $j(".load_more a").on("click", function(b) {
        ...
        var c = $j(this).attr("href"),
            d = ".projects_holder",
            e = ".portfolio_paging .load_more a",
            f = $j(e).attr("href"),
            g = $j(".projects_holder .filler").length,
            h = $j(".portfolio_paging"),
            i = $j(".portfolio_paging_loading");
        h.hide(), i.show(), $j.get(c + "", function(b) {
            if ($j(d).is(".justified-gallery")) {
                var c = $j(d, b).wrapInner("").html();
                f = $j(e, b).attr("href"), $j(d, b).waitForImages(function() { $j(d).find("article:last").after(c), $j(d).find("article").css("visibility", "visible"), $j(d).justifiedGallery("norewind"), prettyPhoto(), $j(".load_more").attr("rel") > a ? $j(".load_more a").attr("href", f) : $j(".load_more").remove(), $j(".projects_holder .portfolio_paging:last").remove(), h.show(), i.hide() })
            } else {
                $j(".projects_holder .filler").slice(-g).remove();
                var c = $j(d, b).wrapInner("").html();
                f = $j(e, b).attr("href"), $j(d, b).waitForImages(function() {
                    if ($j("article.mix:last").after(c), $j(".projects_holder article").css("visibility", "visible"), $j("article:not(.show)").each(function(a) { $j(this).addClass("show") }), $j(".masonry_with_space").length) $j(".masonry_with_space .projects_holder").isotope("reloadItems").isotope();
                    else {
                        var b = $j("article.mix:first").height();
                        $j("article.mix").css("min-height", b), $j(".projects_holder").mixitup("remix", "all")
                    }
                    prettyPhoto(), $j(".load_more").attr("rel") > a ? $j(".load_more a").attr("href", f) : $j(".load_more").remove(), $j(".projects_holder .portfolio_paging:last").remove(), $j("article.mix").css("min-height", 0), h.show(), i.hide()
                })
            }
        }), a++
    })
...
function initPortfolioSingleInfo() {
    ...
    if ($j(".portfolio_single_follow").length > 0) {
        ...
        d.scroll(function() { d.width() > 960 ? d.scrollTop() + e + 3 > b.top ? d.scrollTop() + e + a.height() + 24 < c.top + $scrollHeight ? a.stop().animate({ marginTop: d.scrollTop() - b.top + e }) : a.stop().animate({ marginTop: $scrollHeight - a.height() - 24 }) : a.stop().animate({ marginTop: 0 }) : a.css("margin-top", 0) })
    }
}
...
function initAccordion() {
    "use strict";
    $j(".q_accordion_holder").length && ($j(".q_accordion_holder").appear(function() { $j(".q_accordion_holder").css("visibility", "visible") }, { accX: 0, accY: -100 }), $j(".accordion").length && ($j(".accordion").accordion({ animate: "swing", collapsible: !0, active: !1, icons: "", heightStyle: "content", activate: function(a, b) { initParallax() } }), $j(".accordion").each(function() {
    ...
    })), $j(".toggle").addClass("accordion ui-accordion ui-accordion-icons ui-widget ui-helper-reset").find(".title-holder").addClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-top ui-corner-bottom").hover(function() { $j(this).toggleClass("ui-state-hover") }).click(function() { return $j(this).toggleClass("ui-accordion-header-active ui-state-active ui-state-default ui-corner-bottom").next().toggleClass("ui-accordion-content-active").slideToggle(400), !1 }).next().addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom").hide(), $j(".toggle").each(function() { var a = parseInt($j(this).data("active-tab")); "" !== a && a >= 1 && (a -= 1, $j(this).find(".ui-accordion-content").eq(a).show(), $j(this).find(".ui-accordion-header").eq(a).addClass("ui-state-active")) }))
}

function initAccordionContentLink() {
    "use strict";
    $j(".accordion").length && $j(".accordion_holder .accordion_inner .accordion_content a").click(function() { return "_blank" === $j(this).attr("target") ? window.open($j(this).attr("href"), "_blank") : window.open($j(this).attr("href"), "_self"), !1 })
}
...
function initTestimonials() {
    ...
    $j(".testimonials_carousel").length && $j(".testimonials_carousel").each(function() {
        ...
        var g = qodeNumberOfTestimonialsItems(b),
            h = 0,
            i = 0;
        "undefined" != typeof g && 1 !== g && (h = 200, i = 40), b.flexslider({ animationLoop: !0, controlNav: !1, directionNav: e, useCSS: !1, pauseOnAction: !0, pauseOnHover: !1, slideshow: c, animation: d, itemMargin: i, minItems: g, maxItems: g, itemWidth: h, animationSpeed: f, slideshowSpeed: a, start: function(a) { initParallax() } })
    })
}

function qodeNumberOfTestimonialsItems(a) { var b = a.data("number-per-slide"); return 768 > $window_width && b > 1 ? b = 1 : 1024 > $window_width && b > 2 && (b = 2), b }
...
function initTestimonialsCarousel() {
    ...
    $j(".testimonials_c_carousel").length && $j(".testimonials_c_carousel").each(function() {
        ...
        var f = qodeNumberOfTestimonialsItems(b),
            g = 0,
            h = 0;
        "undefined" != typeof f && 1 !== f && (g = 300, h = 30), b.flexslider({ animationLoop: !0, controlNav: d, directionNav: !1, useCSS: !1, pauseOnAction: !0, pauseOnHover: !1, slideshow: c, animation: "slide", itemMargin: h, minItems: f, maxItems: f, itemWidth: g, animationSpeed: e, slideshowSpeed: a, start: function(a) { initParallax() } })
    })
}

function initMessages() {
    "use strict";
    $j(".q_message").length && $j(".q_message").each(function() { $j(this).find(".close").click(function(a) { a.preventDefault(), $j(this).parent().parent().fadeOut(500) }) })
}
...
function initBlog() {
    ...
    if ($j(".blog_holder.masonry, .blog_holder.blog_pinterest").length) {
        ...
        var b = $j(".blog_holder");
        if (b.waitForImages(function() { setTimeout(function() { b.isotope({ itemSelector: "article", resizable: !1, masonry: { columnWidth: ".blog_holder_grid_sizer", gutter: ".blog_holder_grid_gutter" } }), $j(".blog_holder.masonry, .blog_holder.blog_pinterest").animate({ opacity: "1" }, 500) }, 400) }), $j(".filter").click(function() { var a = $j(this).attr("data-filter"); return b.isotope({ filter: a }), !1 }), b.hasClass("masonry_infinite_scroll")) b.infinitescroll({ navSelector: ".blog_infinite_scroll_button span", nextSelector: ".blog_infinite_scroll_button span a", itemSelector: "article", loading: { finishedMsg: finished_text, msgText: loading_text } }, function(a) { b.isotope("appended", $j(a)), fitVideo(), fitAudio(), initFlexSlider(), setTimeout(function() { $j(".blog_holder.masonry, .blog_holder.blog_pinterest").isotope("layout") }, 400) });
        ...
        if ($j(".filter").click(function() { var a = $j(this).attr("data-filter"); return b.isotope({ filter: a }), !1 }), b.hasClass("masonry_infinite_scroll")) b.infinitescroll({ navSelector: ".blog_infinite_scroll_button span", nextSelector: ".blog_infinite_scroll_button span a", itemSelector: "article", loading: { finishedMsg: finished_text, msgText: loading_text } }, function(a) { b.isotope("appended", $j(a)), fitVideo(), fitAudio(), initFlexSlider(), setTimeout(function() { $j(".blog_holder.masonry_full_width").isotope("layout") }, 400) });
            ...
            $j(".blog_load_more_button a").off("click tap").on("click tap", function(a) {
                ...
                $j.get(d + "", function(a) {
                    ...
                    g = $j(f, a).attr("href"), b.append($j(d)).isotope("reloadItems").isotope({ sortBy: "original-order" }), fitVideo(), fitAudio(), initFlexSlider(), setTimeout(function() { $j(".blog_holder.masonry_full_width").isotope("layout") }, 400), $j(".blog_load_more_button span").attr("rel") > c ? $j(".blog_load_more_button a").attr("href", g) : $j(".blog_load_more_button").remove()
                }), c++
            })
        }
        b.waitForImages(function() { setTimeout(function() { b.isotope({ itemSelector: "article", resizable: !1, masonry: { columnWidth: ".blog_holder_grid_sizer", gutter: ".blog_holder_grid_gutter" } }), $j(".masonry_full_width").animate({ opacity: "1" }, 500) }, 400) })
    }
}
...
function initBlogMasonryGallery() {
    ...
    if ($j(".blog_holder.masonry_gallery").length) {
        ...
        if (a.width(Math.round(a.parent().width())), a.isotope({ itemSelector: "article", resizable: !1, masonry: { columnWidth: ".blog_holder_grid_sizer", gutter: ".blog_holder_grid_gutter" } }), a.waitForImages(function() { a.animate({ opacity: "1" }, 300, function() { a.isotope().isotope("layout") }) }), a.hasClass("masonry_infinite_scroll")) a.infinitescroll({ navSelector: ".blog_infinite_scroll_button span", nextSelector: ".blog_infinite_scroll_button span a", itemSelector: "article", loading: { finishedMsg: finished_text, msgText: loading_text } }, function(b) { a.isotope("appended", $j(b)), fitVideo(), fitAudio(), initFlexSlider(), qodeResizeBlogMasonryGallery($j(".blog_holder_grid_sizer").width()), setTimeout(function() { a.isotope("layout") }, 300) });
        ...
        $j(window).resize(function() { qodeResizeBlogMasonryGallery($j(".blog_holder_grid_sizer").width()), a.isotope().isotope("layout"), a.width(Math.round(a.parent().width())) })
    }
}
...
function initBlogGallery() {
    ...
    if ($j(".blog_holder.blog_gallery, .blog_holder.blog_chequered").length) {
        ...
        if (a.width(Math.round(a.parent().width())), a.isotope({ itemSelector: "article", resizable: !1, masonry: { columnWidth: ".blog_holder_grid_sizer", gutter: ".blog_holder_grid_gutter" } }), a.waitForImages(function() { a.animate({ opacity: "1" }, 300, function() { a.isotope().isotope("layout") }) }), a.hasClass("masonry_infinite_scroll")) a.infinitescroll({ navSelector: ".blog_infinite_scroll_button span", nextSelector: ".blog_infinite_scroll_button span a", itemSelector: "article", loading: { finishedMsg: finished_text, msgText: loading_text } }, function(b) { a.isotope("appended", $j(b)), fitVideo(), fitAudio(), initFlexSlider(), qodeResizeBlogGallery($j(".blog_holder_grid_sizer").width()), setTimeout(function() { a.isotope("layout") }, 300) });
        else if (a.hasClass("masonry_load_more")) {
            var b = 1;
            $j(".blog_load_more_button a").off("click tap").on("click tap", function(c) {
                c.preventDefault();
        ...
        $j(window).resize(function() { qodeResizeBlogGallery($j(".blog_holder_grid_sizer").width()), a.isotope().isotope("layout"), a.width(Math.round(a.parent().width())) })
    }
}
...
function initQBlog() {
    ...
    $j(".q_masonry_blog").length && $j(".q_masonry_blog").each(function() {
        var a = $j(this);
        a.waitForImages(function() { setTimeout(function() { a.isotope({ itemSelector: "article", resizable: !1, masonry: { columnWidth: ".q_masonry_blog_grid_sizer", gutter: ".q_masonry_blog_grid_gutter" } }), a.animate({ opacity: "1" }, 500) }, 400) })
    })
}
...
function qodeBlogCompundMasonryGallery() {
    var a = $j(".qode_blog_masonry_gallery"),
        ...
        e = function() { a.isotope({ itemSelector: ".qode_blog_gallery_item", masonry: { columnWidth: ".qode_blog_gallery_sizer", gutter: ".qode_blog_gallery_gutter" } }) };
    return { init: function() { a.length && (d(), e(), $j(window).resize(function() { d() })) } }
}
...
function qodeBlogHeadlines() {
    ...
    if ($j(".blog_headlines").length) {
        var a = $j(".blog_headlines"),
            b = function() { a.bigtext({ childSelector: "> article > h2", minfontsize: 20 }), a.find("h2").appear(function() { $j(this).addClass("show") }, { accX: 0, accY: -100 }) };
        if (b(), a.hasClass("blog_infinite_scroll")) a.infinitescroll({ navSelector: ".blog_infinite_scroll_button span", nextSelector: ".blog_infinite_scroll_button span a", itemSelector: "article", loading: { finishedMsg: finished_text, msgText: loading_text } }, function() { b() });
    ...
    $j(".q_progress_bars_icons_holder").length && $j(".q_progress_bars_icons_holder").each(function() {
        ...
        a.appear(function() {
            a.find(".q_progress_bars_icons").css("opacity", "1"), a.find(".q_progress_bars_icons").each(function() {
                ...
                "" !== b && ($j(this).find(".q_progress_bars_icons_inner.custom_size .bar").css({ width: b + "px", height: b + "px" }), $j(this).find(".q_progress_bars_icons_inner.custom_size .bar .fa-stack").css({ "font-size": b / 2 + "px" }));
                var c = $j(this).find(".bar");
                c.each(function(b) {
                    if (a > b) {
                        var d = 150 * (b + 1);
                        timeOuts[b] = setTimeout(function() { $j(c[b]).addClass("active") }, d)
                    }
                })
            })
        }, { accX: 0, accY: -200 })
...
function initMasonryGallery() {
    ...
    resizeMasonryGallery($j(".grid-sizer").width()), $j(".masonry_gallery_holder").length && ($j(".masonry_gallery_holder").each(function() {
        var a = $j(this);
        a.waitForImages(function() { a.animate({ opacity: 1 }), a.isotope({ itemSelector: ".masonry_gallery_item", masonry: { columnWidth: ".grid-sizer" } }), a.find(".masonry_gallery_item.parallax_item").each(function(b) { $j(this).masonryParallax(a.data("parallax_item_speed"), !0, a.data("parallax_item_offset")) }) })
...
function initMoreFacts() {
    ...
    $j(".more_facts_holder").length && $j(".more_facts_holder").each(function() {
        ...
        var c = "Less Facts";
        "" !== $j(this).find(".more_facts_button").data("lessfacts") && (c = $j(this).find(".more_facts_button").data("lessfacts")), a.find(".more_facts_button").on("mouseenter", function() { $j(this).css("color", $j(this).data("hovercolor")) }).on("mouseleave", function() { 0 == a.find(".more_facts_outer").height() && $j(this).css("color", $j(this).data("color")) });
        var d = 70;
        ...
        var e = 0,
            f = 600;
        a.find(".more_facts_button").click(function() { e = a.find(".more_facts_inner").height() + d, f = e > 0 && 601 > e ? 800 : e > 600 && 1201 > e ? 1500 : 2100, a.hasClass("more_fact_opened") ? (a.find(".more_facts_fake_arrow").fadeOut(f), a.find(".more_facts_outer").stop().animate({ height: "0px" }, f, function() { a.find(".more_facts_button").is(":hover") || a.find(".more_facts_button").css("color", a.find(".more_facts_button").data("color")), a.removeClass("more_fact_opened"), $j(".parallax_section_holder").length && initParallax() }), $j(this).find(".more_facts_button_text").text(b), $j(this).find(".more_facts_button_arrow").removeClass("rotate_arrow")) : (a.addClass("more_fact_opened"), a.find(".more_facts_fake_arrow").fadeIn(f), a.find(".more_facts_outer").stop().animate({ height: e }, f, function() { $j(".parallax_section_holder").length && initParallax() }), $j(this).find(".more_facts_button_text").text(c), $j(this).find(".more_facts_button_arrow").addClass("rotate_arrow")) })
    })
}
...
function placeholderReplace() {
    ...
    }).blur(function() { var a = $j(this); "" === a.val() && ("password" === this.type && (this.originalType = this.type, this.type = "text"), a.addClass("placeholder"), a.val(a.attr("placeholder"))) }).blur(), $j("#contact-form [placeholder]").parents("form").submit(function() {
...
function backToTop() {
    "use strict";
    $j(document).on("click", "#back_to_top", function(a) { a.preventDefault(), $j("body,html").animate({ scrollTop: 0 }, $j(window).scrollTop() / 3, "linear") })
}
    ...
    $j(".image_hover").length && $j(".image_hover").each(function() {
        $j(this).appear(function() {
            var a = 300,
                ...
                c = a + parseFloat(b),
                d = $j(this);
            setTimeout(function() { d.addClass("show") }, parseFloat(b)), setTimeout(function() { d.removeClass("show") }, c)
        }, { accX: 0, accY: -200 })
    })
}
...
function checkAnchorOnLoad() {
    ...
    $j(".main_menu a, .vertical_menu a, .mobile_menu a").each(function() { var a = $j(this).prop("hash"); "" !== a && $j('[data-q_id="' + a + '"]').length > 0 && $j('[data-q_id="' + a + '"]').offset().top >= $window_height && 0 === $scroll && ($j(this).parent().removeClass("active current-menu-item"), $j(this).removeClass("current")) })
}
...
function checkAnchorOnScroll() {
    "use strict";
    $j("[data-q_id]").length && !$j("header.page_header").hasClass("regular") && ($j("[data-q_id]").waypoint(function(a) { "down" === a && changeActiveState($j(this).data("q_id")) }, { offset: "50%" }), $j("[data-q_id]").waypoint(function(a) { "up" === a && changeActiveState($j(this).data("q_id")) }, { offset: function() { return -($j(this).outerHeight() - 150) } }))
}
...
function initHashClick() {
    ...
    $j(document).on("click", ".main_menu a, .vertical_menu a, .qbutton:not(.contact_form_button), .anchor, .widget li.anchor a", function() {
        ...
        if ("" !== f && "" === $j(this).attr("href").split("#")[0] || "" !== f && "" !== $j(this).attr("href").split("#")[0] && f === window.location.hash || "" !== f && $j(this).attr("href").split("#")[0] === window.location.href.split("#")[0]) {
            ...
            return $j('[data-q_id="' + f + '"]').length > 0 && b.stop().animate({ scrollTop: Math.round(a) }, 1500, function() { anchorActiveState(e) }), history.pushState && history.pushState(null, null, f), !1
        }
    }), $j(document).on("click", ".mobile_menu a", function() {
        var a = $j(this),
            c = $j(this).prop("hash");
        return "" !== c && "" === $j(this).attr("href").split("#")[0] || "" !== c && "" !== $j(this).attr("href").split("#")[0] && c === window.location.hash || "" !== c && $j(this).attr("href").split("#")[0] === window.location.href.split("#")[0] ? ($j('[data-q_id="' + c + '"]').length > 0 && b.animate({ scrollTop: Math.round($j('[data-q_id="' + c + '"]').offset().top - $j(".mobile_menu").height()) }, 500, function() { anchorActiveState(a) }), history.pushState && history.pushState(null, null, c), !1) : void 0
    })
}
...
function countClientsPerRow() {
    ...
    $j(".qode_clients").length && $j(".qode_clients").each(function() {
        ...
        b.find(".qode_client_holder").each(function() { a = a > $j(this).height() ? a : $j(this).height() }), a += 35;
...
function animatedTextIconHeight() {
    ...
    if ($j(".animated_icons_with_text").length) {
        ...
        b.find(".animated_text p").each(function() { a = a > $j(this).height() ? a : $j(this).height() }), 155 > a && (a = 155), b.find(".animated_icon_with_text_inner").height(a)
    }
}
...
function countAnimatedTextIconPerRow() {
    ...
    $j(".animated_icons_with_text").length && $j(".animated_icons_with_text").each(function() {
        ...
        b.find(".animated_icon_with_text_holder").each(function() { a = a > $j(this).height() ? a : $j(this).height() }), a += 30;
        var f = Math.ceil(c / d),
            g = Math.floor(e / f),
            h = e - f * g;
...
function anchorActiveState(a) { a.closest(".main_menu").length > 0 && $j(".main_menu a").parent().removeClass("active"), a.closest(".vertical_menu").length > 0 && $j(".vertical_menu a").parent().removeClass("active"), 0 === a.closest(".second").length ? a.parent().addClass("active") : a.closest(".second").parent().addClass("active"), a.closest(".mobile_menu").length > 0 && ($j(".mobile_menu a").parent().removeClass("active"), a.parent().addClass("active")), $j(".mobile_menu a, .main_menu a, .vertical_menu a").removeClass("current"), a.addClass("current") }
...
function initSearchButton() {
    $j(".search_slides_from_window_top").length && $j(".search_slides_from_window_top").click(function(a) {
        if (a.preventDefault(), $j("html").hasClass("touch")) "0" == $j(".qode_search_form").height() ? ($j('.qode_search_form input[type="text"]').onfocus = function() { window.scrollTo(0, 0), document.body.scrollTop = 0 }, $j('.qode_search_form input[type="text"]').onclick = function() { window.scrollTo(0, 0), document.body.scrollTop = 0 }, $j(".header_top_bottom_holder").css("top", "50px"), $j(".qode_search_form").css("height", "50px"), $j(".content_inner").css("margin-top", "50px"), 34 > $scroll && $j("header.page_header").css("top", "0")) : ($j(".qode_search_form").css("height", "0"), $j(".header_top_bottom_holder").css("top", "0"), $j(".content_inner").css("margin-top", "0"), 34 > $scroll && $j("header.page_header").css("top", -$scroll)), $j(window).scroll(function() { "0" != $j(".qode_search_form").height() && $scroll > 50 && ($j(".qode_search_form").css("height", "0"), $j(".header_top_bottom_holder").css("top", "0"), $j(".content_inner").css("margin-top", "0")) }), $j(".qode_search_close").click(function(a) { a.preventDefault(), $j(".qode_search_form").css("height", "0"), $j(".header_top_bottom_holder").css("top", "0"), $j(".content_inner").css("margin-top", "0"), 34 > $scroll && $j("header.page_header").css("top", -$scroll) });
        else {
        ...
        }), $j(".qode_search_close, .content, footer").click(function(a) { a.preventDefault(), $j(".qode_search_form_3").stop(!0).fadeOut(450, "easeOutExpo") }), $j(".qode_search_form_3").blur(function(a) { $j(".qode_search_form_3").stop(!0).fadeOut(450, "easeOutExpo") })
...
function initCoverBoxes() {
    $j(".cover_boxes").length && $j(".cover_boxes").each(function() {
        ...
        var d = $j(this);
        $j(this).find("li").each(function() { $j(this).hover(function() { $j(d).find("li").removeClass("act"), $j(this).addClass("act") }) })
    })
}
        ...
        if (0 === $j(this).find("ul").length) {
            ...
            c.length && c.each(function() {
                var c, d = $j(this).data("q_id"),
                    ...
                    g = $j("<li />"),
                    h = $j("<i />", { "class": "fa " + f }),
                    i = $j("<a />", { href: d, html: "<span>" + e + "</span>" });
                c = "" !== a ? $j("<div />", { "class": "arrow", style: "border-color: " + a + " transparent transparent transparent" }) : $j("<div />", { "class": "arrow" }), h.prependTo(i), i.appendTo(g), c.appendTo(g), g.appendTo(b)
            })
        }
    })
}
...
function createSelectContentMenu() {
    ...
    a.each(function() {
        ...
        }), a.find(".nav_select_button").on("click", function() { return a.find(".nav_select_menu ul").is(":visible") ? a.find(".nav_select_menu ul").slideUp() : a.find(".nav_select_menu ul").slideDown(), !1 }), a.find(".nav_select_menu ul li a").on("click", function() {
            a.find(".nav_select_menu ul").slideUp();
            var b = $j(this),
                c = b.attr("href"),
                d = $j("div.wpb_row[data-q_id='" + c + "'],section.parallax_section_holder[data-q_id='" + c + "']").offset().top;
            return $j("html,body").stop().animate({ scrollTop: d }, 500, "swing", function() { $j("nav.content_menu ul li").removeClass("active"), b.parent().addClass("active") }), !1
        })
    })
}
...
function contentMenuPosition() {
    ...
    if ($j("nav.content_menu").length) {
        ...
        0 >= content_menu_position - a - content_menu_top_add - $scroll && ($j("header").hasClass("stick") || $j("header").hasClass("stick_with_left_right_menu")) ? (sticky_amount > content_menu_position ? $scroll > sticky_amount ? $j("nav.content_menu").css({ position: "fixed", top: min_header_height_sticky + content_menu_top_add }).addClass("fixed") : $j("nav.content_menu").css({ position: "fixed", top: 0, transition: "none" }).addClass("fixed") : $j("nav.content_menu").css({ position: "fixed", top: min_header_height_sticky + content_menu_top_add }).addClass("fixed"), $j("header.sticky").addClass("no_shadow"), $j(".content > .content_inner > .container > .container_inner").css("margin-top", content_line_height), $j(".content > .content_inner > .full_width").css("margin-top", content_line_height)) : 0 >= content_menu_position - content_menu_top - content_menu_top_add - $scroll && !$j("header").hasClass("stick") ? ($j("nav.content_menu").css({ position: "fixed", top: content_menu_top + content_menu_top_add }).addClass("fixed"), $j(".content > .content_inner > .container > .container_inner").css("margin-top", content_line_height), $j(".content > .content_inner > .full_width").css("margin-top", content_line_height)) : ($j("nav.content_menu").css({ position: "relative", top: "0px" }).removeClass("fixed"), $j("header.sticky").removeClass("no_shadow"), $j(".content > .content_inner > .container > .container_inner").css("margin-top", "0px"), $j(".content > .content_inner > .full_width").css("margin-top", "0px")), $j(".content .in_content_menu").waypoint(function(a) {
            var b = $j(this),
                c = b.data("q_id");
...
function initButtonHover() {
    $j(".qbutton").length && $j(".qbutton").each(function() {
        if ("undefined" != typeof $j(this).data("hover-background-color") && $j(this).data("hover-background-color") !== !1) {
            ...
            $j(this).hover(function() { $j(this).css("background-color", a) }, function() { $j(this).css("background-color", b) })
        }
        if ("undefined" != typeof $j(this).data("hover-border-color") && $j(this).data("hover-border-color") !== !1) {
            ...
            $j(this).hover(function() { $j(this).css("border-color", c) }, function() { $j(this).css("border-color", d) })
        }
        if ("undefined" != typeof $j(this).data("hover-color") && $j(this).data("hover-color") !== !1) {
            var e = $j(this).data("hover-color"),
                f = $j(this).css("color");
            $j(this).hover(function() { $j(this).css("color", e) }, function() { $j(this).css("color", f) })
        }
    })
}
...
function initEnlargeButton() {
    $j(".qbutton.enlarge").length && $j(".qbutton.enlarge").each(function() {
        ...
        a.mouseenter(function() { a.css({ "padding-left": b + c }), a.css({ "padding-right": b + c }) }), a.mouseleave(function() { a.css({ "padding-left": b }), a.css({ "padding-right": b }) })
    })
}
...
function initSocialIconHover() {
    $j(".q_social_icon_holder").length && $j(".q_social_icon_holder").each(function() {
        if ("undefined" != typeof $j(this).data("hover-background-color") && $j(this).data("hover-background-color") !== !1) {
            ...
            $j(this).find(".fa-stack").hover(function() { $j(this).css("background-color", a) }, function() { $j(this).css("background-color", b) })
        }
        if ("undefined" != typeof $j(this).data("hover-border-color") && $j(this).data("hover-border-color") !== !1) {
            var c = $j(this).data("hover-border-color"),
                d = $j(this).find(".fa-stack").css("border-top-color");
            $j(this).find(".fa-stack").hover(function() { $j(this).css("border-color", c) }, function() { $j(this).css("border-color", d) })
        }
        if ("undefined" != typeof $j(this).data("hover-color") && $j(this).data("hover-color") !== !1) {
            var e, f, g = $j(this).data("hover-color");
            $j(this).find(".fa-stack i, .fa-stack span").length ? (e = "undefined" != typeof $j(this).data("color") ? $j(this).data("color") : $j(this).find(".fa-stack i, .fa-stack span").css("color"), f = $j(this).find(".fa-stack i, .fa-stack span").attr("style")) : $j(this).find(".simple_social").length && (e = "undefined" != typeof $j(this).data("color") ? $j(this).data("color") : $j(this).find(".simple_social").css("color"), f = $j(this).find(".simple_social").attr("style")), $j(this).find(".fa-stack").length ? $j(this).find(".fa-stack").hover(function() { $j(this).find("i, span").attr("style", function(a, b) { return f + "color: " + g + "!important;" }) }, function() { $j(this).find("i, span").attr("style", function(a, b) { return f + "color: " + e + ";" }) }) : $j(this).find(".simple_social").length && $j(this).find(".simple_social").hover(function() { $j(this).attr("style", function(a, b) { return f + "color: " + g + "!important;" }) }, function() { $j(this).attr("style", function(a, b) { return f + "color: " + e + ";" }) })
        }
    })
}
...
function getParentBackgroundColor(a) { return a.parents().filter(function() { var a = $j(this).css("background-color"); return "transparent" != a && "rgba(0, 0, 0, 0)" != a }).eq(0).css("background-color") }

function setActiveTabBorder() { $j(".q_tabs li.active").length && $j(this).click(function() { initTabsActiveBorder() }) }
...
function initFullScreenTemplate() {
    ...
    if ($j(".full_screen_holder").length && $window_width > 600) {
        var a = "";
        a = $j("header.page_header").hasClass("light") ? "light" : $j("header.page_header").hasClass("dark") ? "dark" : header_style_admin, $j(".full_screen_preloader").css("height", $window_height), $j("#up_fs_button").on("click", function() { return $j.fn.fullpage.moveSectionUp(), !1 }), $j("#down_fs_button").on("click", function() { return $j.fn.fullpage.moveSectionDown(), !1 });
...
function checkHeaderStyleOnScroll() {
    ...
    if ($j("[data-q_header_style]").length > 0 && $j("header").hasClass("header_style_on_scroll")) {
        ...
        }, { offset: function() { return -$j(this).outerHeight() + c } })
    }
}
...
function initVerticalSplitSlider() {
    ...
    }), $j("body").hasClass("vss_responsive_adv") && (768 > $window_width ? ($j.fn.multiscroll.destroy(), $j("html,body").css("height", "auto").css("overflow", "auto")) : ($j.fn.multiscroll.build(), $j("html,body").css("height", "100%").css("overflow", "hidden")), $j(window).resize(function() { 768 > $window_width ? ($j.fn.multiscroll.destroy(), $j("html,body").css("height", "auto").css("overflow", "auto")) : ($j.fn.multiscroll.build(), $j("html,body").css("height", "100%").css("overflow", "hidden")) }))) : $j(".full_screen_holder").length || $j("html,body").css("height", "auto").css("overflow", "auto")
}
...
function initializeGoogleMap(a, b, c, d, e, f, g, h, i, j, k, l) {
    ...
    var p = new google.maps.LatLng(-34.397, 150.644),
        q = { zoom: f, scrollwheel: e, center: p, zoomControl: !0, zoomControlOptions: { style: google.maps.ZoomControlStyle.SMALL, position: google.maps.ControlPosition.RIGHT_CENTER }, scaleControl: !1, scaleControlOptions: { position: google.maps.ControlPosition.LEFT_CENTER }, streetViewControl: !1, streetViewControlOptions: { position: google.maps.ControlPosition.LEFT_CENTER }, panControl: !1, panControlOptions: { position: google.maps.ControlPosition.LEFT_CENTER }, mapTypeControl: !1, mapTypeControlOptions: { mapTypeIds: [google.maps.MapTypeId.ROADMAP, "qode_style"], style: google.maps.MapTypeControlStyle.HORIZONTAL_BAR, position: google.maps.ControlPosition.LEFT_CENTER }, mapTypeId: m };
...
function initHorizontalMarquee() {
    ...
    a.each(function() {
        var a, b, c, d, e = function() { d = i.width(), c = 0, l.find("> .qode-hm-item").css("margin", 0), i.height(Math.min($window_height, k)), l.find("> .qode-hm-item").each(function() { $j(this).css("max-width", d), c += $j(this).outerWidth() + j }), c -= j, l.width(c).css("left", 0), l.find("> .qode-hm-item").css("margin-right", j + "px") },
            f = function(c) { c = "undefined" != typeof c.originalEvent ? c.originalEvent : c, c = "touchstart" == c.type ? c.touches[0] : c, a = { x: c.clientX, y: c.clientY }, b = parseInt(l.css("left"), 10), l.addClass("qode-dragged") },
            g = function(a) { l.removeClass("qode-dragged") },
            h = function(e) {
        ...
        e(), $j(window).resize(e), l.find("img").on("dragstart", function(a) { a.preventDefault() }), l.on("mousedown touchstart", f), l.on("mousemove touchmove", h), l.on("mouseup touchend mouseleave", g)
    })
}
...
function initTextMarquee() {
    ...
    a.length && a.each(function() {
        ...
        if (c.stretch(), b.eq(1).addClass("qode-marquee-additional-title"), c.css("visibility", "visible"), $j("html").hasClass("touch")) $j(window).resize(function() { c.unwrap(".stretch--resizer"), c.unwrap(".stretch--handle"), c.stretch() });
        else {
            qodeRequestAnimationFrame();
            var d = b.first(),
                e = d.offset().left,
                f = b.last();
            f.offset({ left: e - $j(window).width() }), b.each(function() {
                var a = $j(this),
                    b = a.offset().left,
                    c = 0,
                    d = 2,
                    e = function() { c += d, a.offset().left > $j(window).width() && (c = -($j(window).width() + b)), a.css("transform", "translate3d(" + c + "px,0,0)"), requestAnimFrame(e) };
                e()
            })
        }
    })
    ...
    a.length && a.each(function() {
        function a(a) {
            b.find(a).each(function(a) {
                var b = $j(this);
                setTimeout(function() { b.addClass("qode-appeared") }, 150 * a)
            })
        }
        var b = $j(this),
            ...
            b.appear(function() {
                e.addClass("qode-appeared"), f.each(function() {
                    var a = $j(this),
                        ...
                        c = b.height() - b.find(".qode-item").last().height();
                    a.css("height", c), a.css("opacity", 1)
                }), b.on("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function(b) { $window_width > 1200 ? (a(".qode-holder-left .qode-item"), a(".qode-holder-right .qode-item")) : a(".qode-item") })
            })
        }, 100))
    })
}
...
function initPreviewSlider() {
    ...
    a.each(function() {
        var a = $j(this),
            ...
            e = 5e3,
            f = 700;
        b.find(".qode-presl-link.small").each(function(a) { $j('<li><div class="qode-presl-small-item"><div class="qode-presl-main-item-inner"></div></div></li>').appendTo(d.find("> .slides")).find(".qode-presl-main-item-inner").append($j(this)) }), b.flexslider({
            animation: "slide",
            animationSpeed: f,
            slideshow: !0,
            slideshowSpeed: e,
            ...
            start: function(a) { a.find(".qode-presl-main-item").css({ opacity: "1", filter: "alpha(opacity=100)" }).find("img").addClass("visible") },
            before: function(a) {
                var b = a.animatingTo,
                    c = a.currentSlide;
            ...
            after: function(a) { a.removeClass("control-initiated direction-initiated"), a.find(".clone_start, .clone_end").remove(), a.find(".flex-direction-nav").removeClass("moving") }
        }), d.flexslider({ animation: "slide", animationSpeed: f, animationLoop: !0, useCSS: !0, touch: !1, slideshow: !1, directionNav: !1, controlNav: !0, start: function(a) { a.find("img").addClass("visible"), a.closest(".qode-presl-small-slider-holder").find(".qode-presl-phone").addClass("visible") } })
    })
}
...
function initInDeviceSlider() {
    ...
    a.each(function() {
        var a = $j(this).find(".qode-ids-slider"),
            ...
            f = getIEversion();
        if (f > 0 && a.addClass("qode-ids-ie-specific"), a.flexslider({ animation: "slide", animationSpeed: 700, animationLoop: !0, useCSS: !0, touch: !e, slideshow: c, slideshowSpeed: d, directionNav: b, controlNav: !1, prevText: '<i class="icon-arrows-left"></i>', nextText: '<i class="icon-arrows-right"></i>', start: function(a) { a.find("img").addClass("visible"), a.closest(".qode-ids-slider-holder").find(".qode-ids-frame").addClass("visible"), a.is(".qode-ids-titles-on-hover") && a.hover(function() { $j(this).find(".qode-ids-link").addClass("hovered") }, function() { $j(this).find(".qode-ids-link").removeClass("hovered") }) } }), e) {
            var g, h = !1,
                i = function(a) { a = "undefined" != typeof a.originalEvent ? a.originalEvent : a, a = "touchstart" == a.type ? a.touches[0] : a, g = { x: a.clientX, y: a.clientY } },
                j = function(a) {
                ...
                k = function(a) { h ? h = !1 : a.preventDefault() };
            a.find(".qode-ids-link").on("dragstart", function(a) { a.preventDefault() }).on("click", k).on("mousedown touchstart", i).on("mouseup touchend", j)
        }
    })
}
...
function drawSVG(a) {
    ...
    b.forEach(function(a, b) {
        var d = new SVGEl(a);
        c[b] = d, setTimeout(function(a) { return function() { d.render() } }(a), 0)
    })
}
...
function initIconShortcodeHover() {
    ...
    $j(".qode_icon_shortcode").length && $j(".qode_icon_shortcode").each(function() {
        if ("undefined" != typeof $j(this).data("type") && -1 != ["circle", "square"].indexOf($j(this).data("type")) && "undefined" != typeof $j(this).data("hover-bg-color"))
            if ("circle" == $j(this).data("type")) {
                var a = $j(this).find("i").first(),
                    ...
                    c = a.attr("style");
                $j(this).hover(function() { a.attr("style", c + "color: " + b + "!important") }, function() { a.attr("style", c) })
            } else {
                var b = $j(this).data("hover-bg-color"),
                    d = $j(this).css("background-color");
                $j(this).hover(function() { $j(this).css("background-color", b) }, function() { $j(this).css("background-color", d) })
            }
        if ("undefined" != typeof $j(this).data("hover-icon-color")) {
            ...
            $j(this).hover(function() { $j(this).find(".qode_icon_element ").css("color", e) }, function() { $j(this).find(".qode_icon_element ").css("color", f) })
        }
    })
}
    ...
    $j(".qode_iwt_icon_holder").length && $j(".qode_iwt_icon_holder").each(function() {
        ...
        if ("undefined" != typeof $j(this).data("icon-hover-color")) {
            var c = $j(this).find(".qode_iwt_icon_element"),
                ...
                e = c.css("color");
            $j(this).hover(function() { c.css("color", d) }, function() { c.css("color", e) })
        }
    })
}
    ...
    if ($j(".blog_vertical_loop").length) {
        ...
        $j(document).on("click", ".blog_vertical_loop_button a", function(f) {
            ...
            var k = $j(window).scrollTop(),
                ...
                m = l - k - a - c;
            e.find("article:eq(1)").addClass("fade_out"), g.closest("article").addClass("move_up").removeClass("next_post").css("transform", "translateY(-" + m + "px)"), setTimeout(function() { $j(window).scrollTop(0), e.find("article:eq(0)").remove(), e.find("article:eq(0)").addClass("previous_post"), g.closest("article").removeAttr("style").removeClass("move_up") }, 450), $j.get(h + "", function(a) {
...
function parallaxLayers() {
    ...
    $j(".qode_parallax_layers").length && $j(".qode_parallax_layers").each(function() {
        var a = $j(this);
        if ($j(this).hasClass("full_screen_height")) a.height($window_height), $j(window).resize(function() { a.height($window_height) });
        else {
            var b = $j(this).data("height");
            setParallaxLayersHeight(a, b), $j(window).resize(function() { setParallaxLayersHeight(a, b) })
        }
        ...
        a.find(".image").each(function() {
            ...
            if ("" != a.css("background-image") && "none" != a.css("background-image")) {
                ...
                if (b = b.match(/url\(["']?([^'")]+)['"]?\)/), b = b ? b[1] : "") {
                    var f = new Image;
                    f.src = b, $j(f).load(function() { d++, d == e && (c.removeClass("preload_parallax_layers"), $j("html").hasClass("no-touch") && c.mouseParallax()) })
                }
            }
        })
    })
...
function initContentSlider() {
    ...
    $j(".qode_content_slider").each(function() {
        ...
        var i = !1;
        a.find(".qode-lazy-image").length && (i = !0), a.flexslider({ selector: ".qode_content_slider_inner > .qode_content_slider_item", animationLoop: !0, controlNav: d, directionNav: c, useCSS: !1, pauseOnAction: e, pauseOnHover: e, slideshow: g, animation: h, prevText: "<div><i class='fa fa-angle-left'></i></div>", nextText: "<div><i class='fa fa-angle-right'></i></div>", animationSpeed: 600, slideshowSpeed: b, touch: !0, smoothHeight: i, start: function() { j(a) }, after: function() { j(a) } });
        var j = function(b) { a.find(".qode-lazy-image").length && qodeLazyImages() };
        if (a.find(".flex-direction-nav a").click(function(a) { a.preventDefault(), a.stopImmediatePropagation(), a.stopPropagation() }), f && a.swipe({ swipeLeft: function() { a.flexslider("next") }, swipeRight: function() { a.flexslider("prev") }, threshold: 20 }), a.hasClass("control_nav_justified")) {
            var k = function(b) {
                var c = a.find("ol");
                c.addClass("qode-type1-gradient-left-to-right-after"), $window_width >= 1200 ? c.css("max-width", qode_grid_width) : c.css("max-width", a.outerWidth());
                var d = c.find("li"),
                    e = d.outerWidth(),
            ...
            k(a), $j(window).resize(function() { k(a) })
        }
    })
}
...
function qodeInitStickyWidget() {
    ...
    if (a.length && $window_width > 1e3) {
        ...
        sticky_amount = getScrollAmountForStickyHeader(), a.each(function() {
            ...
            var h = -(e - g - d - 10);
            f.stick_in_parent({ parent: c, sticky_class: "qode-sticky-sidebar", inner_scrolling: !1, offset_top: h }).on("sticky_kit:bottom", function() { f.addClass("qode-sticky-sidebar-on-bottom") }).on("sticky_kit:unbottom", function() { f.removeClass("qode-sticky-sidebar-on-bottom") }), $j(window).scroll(function() { $window_width >= 1e3 && (sticky_amount > g && b.hasClass("sticky") && f.hasClass("qode-sticky-sidebar") && !f.hasClass("qode-sticky-sidebar-on-bottom") ? (f.css("-webkit-transform", "translateY(" + min_header_height_sticky + "px)"), f.css("transform", "translateY(" + min_header_height_sticky + "px)")) : (f.css("-webkit-transform", "translateY(0px)"), f.css("transform", "translateY(0px)"))) })
        })
    }
}
...
function qodeBlogGalleryAnimation() {
    ...
    a.length && a.each(function() {
        ...
        b.each(function() {
            ...
            d.css({ transform: "translateY(" + c + "px)" }), e.css({ transform: "translateY(" + c + "px)" }), a.mouseenter(function() { d.css({ transform: "translateY(0px)" }), e.css({ transform: "translateY(0px)" }), b.css({ visibility: "visible", opacity: "1" }) }), a.mouseleave(function() { d.css({ transform: "translateY(" + c + "px)" }), e.css({ transform: "translateY(" + c + "px)" }), b.css({ visibility: "hidden", opacity: "0" }) })
        })
    })
}
...
function qodeCardsGallery() {
    $j(".qode-cards-gallery-holder").length && $j(".qode-cards-gallery-holder").each(function() {
        ...
        c.each(function() {
            var d = $j(this);
            d.click(function() { return c.last().is(d) ? void 0 : (d.addClass("out").animate({ opacity: 0, margin: a }, 200, function() { d.detach(), d.insertAfter(c.last()).animate({ opacity: 1, margin: "0" }, 500, function() { d.removeClass("out") }), c = b.find(".card") }), !1) })
        })
    })
}
...
! function(a) {
    ...
    a.fn.masonryParallax = function(c, d, e) {
        function f() { $scroll > k + l || k > $scroll + $window_height || i.css("transform", "translate3d(0px, " + Math.round((h - l - $scroll) * c + j) + "px, 0px)") }
        var g, h, i = a(this),
            j = 0;
        h = i.offset().top, g = d ? function(a) { return a.outerHeight(!0) } : function(a) { return a.height() }, 0 != e && (j = e), (arguments.length < 1 || null === c) && (c = .1), (arguments.length < 2 || null === d) && (d = !0);
        var k = i.offset().top,
            l = g(i);
...
var qodeV2Button = function() {
        var a = $j(".qode-btn"),
            b = function(a) {
                if ("undefined" != typeof a.data("hover-color")) {
                    var b = function(a) { a.data.button.css("color", a.data.color) },
                        c = a.css("color"),
                        d = a.data("hover-color");
                    a.hasClass("qode-btn-3d-hover") || (a.on("mouseenter", { button: a, color: d }, b), a.on("mouseleave", { button: a, color: c }, b))
                }
            },
            c = function(a) {
                if ("undefined" != typeof a.data("hover-bg-color")) {
                    var b = function(a) { a.data.button.css("background-color", a.data.color) },
            ...
            d = function(a) {
                ...
                if ("undefined" != typeof b.data("hover-icon-border-color")) {
                    var c = function(a) { a.data.iconHolder.css("border-color", a.data.color) },
                        d = b.css("borderLeftColor"),
                        e = b.data("hover-icon-border-color");
                    a.hasClass("qode-btn-3d-hover") || (a.on("mouseenter", { iconHolder: b, color: e }, c), a.on("mouseleave", { iconHolder: b, color: d }, c))
                }
            },
            e = function(a) {
                if (a.hasClass("qode-btn-3d-hover")) {
                    var b = a.closest(".qode-3d-button-holder"),
                        ...
                        g = b.outerHeight(),
                        h = Math.round(g / 2);
                    if (e.css("transform", "rotateX(90deg) translateZ(" + h + "px)"), b.on("mouseenter", function() { d.css("transform", "rotateX(-90deg) translateZ(" + h + "px)"), e.css("transform", "rotateX(0deg) translateZ(" + h + "px)") }), b.on("mouseleave", function() { d.css("transform", "rotateX(0deg) translateZ(" + h + "px)"), e.css("transform", "rotateX(90deg) translateZ(" + h + "px)") }), "undefined" != typeof e.data("hover-color")) {
        ...
        return { init: function() { a.length && a.each(function() { b($j(this)), c($j(this)), d($j(this)), e($j(this)) }) } }
    },
            ...
            b = function() {
                a.each(function() {
                    ...
                    if (!$j("html").hasClass("touch") && a.hasClass("qode-cta-appear-effect")) {
                        var d = function(a) { a.appear(function() { setTimeout(function() { a.addClass("qode-appeared") }, 30) }, { accX: 0, accY: -($window_height / 3) }) };
                        d(b), d(c)
                    }
                })
            };
        return { init: function() { a.length && b() } }
    },
...
window.requestAnimFrame = function() { return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(a) { window.setTimeout(a, 1e3 / 60) } }(), window.cancelAnimFrame = function() { return window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.oCancelAnimationFrame || window.msCancelAnimationFrame || function(a) { window.clearTimeout(a) } }(), SVGEl.prototype.init = function() {
        ...
        if (b > 1) window.cancelAnimFrame(this.handle);
            ...
            this.handle = window.requestAnimFrame(function() { a.draw() })
        }
    },
    function(a) {
        "use strict";
        a.fn.extend({
            mouseParallax: function(b) {
                var c = { moveFactor: 1.5, targetContainer: this },
                    b = a.extend(c, b);
                return this.each(function() {
                    var c = b,
                        d = a(c.targetContainer).find(".image, .paralax_layers_content_holder");
                    d.each(function(b) { a(this).css("z-index", b) });
                    var e, f;
                    e = a(c.targetContainer).offset().left, f = a(c.targetContainer).offset().top, a(c.targetContainer).on("mouseenter", function(b) { e = b.pageX - a(this).offset().left, f = b.pageY - a(this).offset().top }), a(c.targetContainer).on("mousemove", function(b) {
                        var g = a(this).offset().left + e,
                            h = a(this).offset().top + f,
                            i = b.pageX - g,
                            j = b.pageY - h;
                        d.each(function(b) { a(this).css({ marginLeft: -i / 100 * c.moveFactor * (b + 1), marginTop: -j / 100 * c.moveFactor * (b + 1) }, 100) })
                    });
                    var g = { interval: 0, over: function() {}, timeout: 500, out: function() { d.each(function(b) { a(this).stop().animate({ marginLeft: 0, marginTop: 0 }, 300) }) } };
...
var qodeCardsSlider = function() {
    var a = function(a, b, c, d, e, f) {
            b.data("slide", d).attr("data-slide", d), b.find(".qode-card-slider").css("margin-left", f ? -e.position().left + $j(b).outerWidth() / 2 - e.outerWidth() / 2 : -e.position().left), setTimeout(function() { qodeLazyImages() }, 500);
            var g = d > c ? 1 : -1;
        ...
        b = function(b, c, d) {
            b.each(function(b, e) {
                ...
                c ? (g.length > 0 ? $j(g[h]).click() : a(f, $j(e), 1, h, $j(f[h]), d), $j(e).data("slide", h + 1).attr("data-slide", h + 1), $j(e).find(".button").removeClass("hidden")) : g.length > 0 ? $j(g[0]).click() : a(f, $j(e), 1, 1, $j(f[0]), d)
            })
        },
        c = function(a, b, c) { b.find(".qode-card-slider").width(99999), a.each(function() { $j(this).css("max-width", b.outerWidth()) }) },
        d = function() {
            var a = $j(".cards");
            a.each(function() {
                var a = $j(this),
                ...
                b.each(function() {
                    var c = $j(this);
                    c.click(function() { return b.last().is(c) || (c.detach(), c.insertAfter(b.last()), b = a.find(".card")), !1 })
                })
            })
        },
        e = function() {
            ...
            a.each(function() {
                ...
                a.appear(function() {
                    $j(b).each(function(a) {
                        var b = $j(this);
                        setTimeout(function() { b.addClass("hovered"), setTimeout(function() { b.removeClass("hovered") }, 600) }, 200 * a)
                    })
                }, { accX: 0, accY: -($window_height / 3) })
            })
        },
        f = function() { $j(".qode-cards-holder .card").each(function(a, b) { $j(b).click(function() { var a = $j("." + $j(b).data("value")); return a.closest(".qode-card-panes").find(".pane").removeClass("active"), a.addClass("active"), qodeLazyImages(), !1 }) }), $j(".qode-cards-holder").each(function(a, b) { $j(b).find(".qode-card-panes .pane").last().addClass("active"), $j(b).find(".qode-card-panes .pane .card").length ? $j(b).find(".qode-card-panes .pane .card").each(function(a, c) { $j(c).detach(), $j(b).find(".qode-cards-header").append($j(c)) }) : $j(b).find(".qode-cards-header").remove() }) },
        g = function() {
        ...
        h = function(a) { a.swipe({ swipeLeft: function() { a.find('.button[data-direction="next"]').click() }, swipeRight: function() { a.find('.button[data-direction="prev"]').click() }, threshold: 20 }) },
        i = function() {
                ...
                $j(e).find(".button").each(function(b, c) {
                    $j(c).click(function() {
                        var b = "prev" == $j(c).data("direction") ? -1 : 1,
                            d = $j(e).data("slide"),
                            g = $j(e).data("slide") + b,
                            h = $j(e).find('.slide[data-slide="' + g + '"]');
                        return h.length && (a(f, $j(e), d, g, h, j), $j(e).find(".dot").removeClass("active").filter('[data-slide="' + g + '"]').addClass("active")), !1
                    })
                }), $j(e).find(".dot").each(function(b, c) {
                    $j(c).click(function() {
                        $j(e).find(".dot").removeClass("active"), $j(c).addClass("active");
                        var b = $j(e).data("slide"),
                            d = $j(c).data("slide"),
                            g = $j(e).find('.slide[data-slide="' + d + '"]');
                        return g.length && a(f, $j(e), b, d, g, j), !1
                    })
                }), c(f, $j(e), !1), b($j(e), i, j), h($j(e)), $j(window).resize(function() { c(f, $j(e), !0), b($j(e), i, j), g() })
            })
        };
    return { init: function() { $j(".qode-card-slider-holder").length && (i(), g(), f(), d()) }, load: function() { $j(".qode-card-slider-holder").length && (g(), e()) } }
};